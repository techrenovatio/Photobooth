...
<body>
    ...
    <!-- WATERMARK LOGO HIMSI (Diperbesar 2x lipat di Desktop/lg) -->
    <div class="fixed inset-0 z-0 flex items-center justify-center pointer-events-none opacity-[0.08]">
        <img src="Logohimsi.png" alt="Watermark HIMSI" class="w-[80vw] md:w-[450px] lg:w-[1200px] object-contain">
    </div>
    ...
    <div class="bg-red-950 text-white px-6 py-4 flex items-center shadow-md sticky top-0 z-50 gap-4 relative">
        ...
        <div class="font-bold text-lg tracking-wider">HIMSI UNIS KABINET GENESIS<span class="text-red-300 font-normal text-sm ml-2 hidden sm:inline-block">| Organization Chart</span></div>
    </div>
